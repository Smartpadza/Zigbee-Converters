...
module.exports = {
    fingerprint: [{
        modelID: 'TS0601',
        manufacturerName: '_TZE284_7ytnacie'
    }],
    model: 'jhy-wznh8_4g',
    vendor: 'Tuya',
    description: 'SmartPad 4-Gang Tactile Zigbee Wall Switch',
    ...
    exposes: [
        ...
        e.binary('state_l3', ea.STATE_SET, 'ON', 'OFF'),
        e.binary('state_l4', ea.STATE_SET, 'ON', 'OFF'),		
